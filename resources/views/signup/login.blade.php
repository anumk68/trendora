            ...
            <div class="row g-0">
              ...
              <div class="col-lg-6">
                <div class="card-body p-4 p-sm-5">
                  ...
                  <form class="form-body" action="{{ route('authenticate') }}" method="post">
                    @csrf
                    <div class="d-grid">
                      @if($errors->any())
                  ...
                  <div class="text-center my-4">
                    ...
                    <a href="{{ route('login.google') }}" class="btn btn-danger mt-3" type="submit">Sign In with Google</a>
