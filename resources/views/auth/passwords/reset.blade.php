...
<head>
  ...
  <title>Trendora -Reset Password</title>
</head>
                        ...
                        <div class="row g-3">
                          <div class="col-12">
                            ...
                            <div class="ms-auto position-relative">
                              ...
                              <input type="email" class="form-control radius-30 ps-5" id="inputNewPassword" placeholder="Enter New Password" name="password">
                            </div>
                          </div>
                          <div class="col-12">
